...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log(`[Knowledge Base Approve] User: ${userEmail} (${userRole}) approving file: ${fileId}`);
    ...
    console.log(`[Knowledge Base Approve] SUCCESS: ${fileName} approved by ${userEmail}`);
    ...
    console.error('[Knowledge Base Approve] Error:', error);
